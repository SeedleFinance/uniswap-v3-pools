...
import TransferModal from '../PoolDetailsLayout/TransferModal';
        ...
        <div>
          <div className="flex justify-between items-center mt-8">
            ...
            <div className="flex gap-1">
              <Button disabled={false} tabIndex={8} className="mr-2" onClick={handleClickTransfer}>
              ...
              <DropdownMenu
                options={[
                  {
                    label: 'Remove',
                    cb: () => handleRemovePosition(position.id),
                    icon: <IconTrash />,
                  },
                ]}
              >
